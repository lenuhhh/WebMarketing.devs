...
function Placeholder({ tab }) {
  return (
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'5rem 2rem',textAlign:'center',color:'var(--faint)',gap:'.875rem'}}>
      <div style={{fontSize:'3rem'}}>🚧</div>
      <h2 style={{fontFamily:'var(--font-serif)',fontSize:'1.25rem',fontWeight:600,color:'var(--muted)'}}>{tab?.label}</h2>
      <p style={{fontSize:'.82rem',maxWidth:'320px'}}>Розділ готується.</p>
    </div>
  );
}
